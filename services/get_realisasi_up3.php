...
$sql = "SELECT up3, wig, lm, SUM(target) AS total_target, SUM(realisasi) AS total_realisasi FROM t_transaksi WHERE wig='$wig' AND lm ='$lm' AND tanggal_insert BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY up3 ASC" ;
